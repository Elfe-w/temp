...
import time
from demo_need import  datasetSplit,DataSet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='data/oj/node_emb',
                        help='node emb path')
    ...
    train_data,val_data,test_data=datasetSplit(data_path,train_ratio,val_ratio,test_ratio)
    dataSet = DataSet()
